...
- that people can already find Mythical Void through search;
- that the game is easy for unfamiliar players;
- that players enjoy, value, return to or recommend it;
- that impressions, Play selections or automated checks are people;
- that imagined artwork proves gameplay quality;
- that any portal will accept the game.

The most important growth question remains simple: **when someone who wants a
new game chooses Mythical Void, do they reach a creature moment they understand
