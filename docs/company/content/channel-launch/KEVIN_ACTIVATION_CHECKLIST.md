...
4. Paste the prepared description from [`channel-activation-pack.json`](channel-activation-pack.json).
5. Choose **Review this setting for every video** for the audience setting. This matters because future videos may speak to different groups.
6. Keep comments **off** for now. Once a named adult is checking them, change the default to **Hold all**.
7. Turn on multi-factor authentication. Add a backup adult with a channel role instead of sharing the Google password.
8. Send back the exact channel link. Nothing will be published automatically.
