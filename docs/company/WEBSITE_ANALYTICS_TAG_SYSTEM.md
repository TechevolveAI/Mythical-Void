...
The five actions carry one broad page group such as `home`, `story`,
...
- all ten public information routes use the same boundary;
...
5. that the ten public page groups and five allowed actions arrive; and
