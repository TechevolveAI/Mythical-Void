...
describe('Village settlement gameplay contract', () => {
    ...
    test('completed buildings appear as connected world structures in the Sanctuary', () => {
        ...
        expect(world).toContain("setData('villageReservedFoundationCount'");
        ...
        expect(world).toContain('drawVillageGrowthStageEcology({');
        expect(world).toContain("setData('villageGrowthWorldIdentity', profile.worldIdentity)");
        expect(world).toContain("setData('villageGrowthCanopyCount', canopyBasins.length)");
        expect(world).toContain("setData('villageGrowthCurrentNodeCount', profile.currentNodeCount)");
        expect(world).toContain("setData('villageGrowthGatheringCapacity', profile.gatheringCapacity)");
        expect(world).toContain("setData('villageGrowthStageProfile', 'living_settlement_tiers_v1')");
        expect(world).toContain('createVillageCommonsLife(snapshot, {');
        expect(world).toContain('createVillageResidentJourneys(');
        expect(world).toContain("setData('villageCommonsLife', true)");
        expect(world).toContain("setData('villageCommonsRoutine', 'heart_check_in')");
        expect(world).toContain("setData('villageCommonsPresenceModel', 'single_world_location_v1')");
        expect(world).toContain("setData('villageCommonsResidentCount', residents.length)");
        expect(world).toContain("setData('villageCommonsResidentNames'");
        ...
        expect(village).toContain("worldIdentity: 'current_canopy'");
        ...
        expect(world).toContain('getVillageGrowthProfile(tier).label');
        ...
        expect(world).toContain("? 'at_heart'");
        expect(world).toContain("tether.setData('villageHomeTether', true)");
        expect(world).toContain("tether.setData('villageCommonsTether', true)");
        expect(world).toContain("figure.setData('villageResidentFigure', true)");
        expect(world).toContain("container.setData('homeTetherCount', workingResidentCount)");
        ...
        expect(world).toContain(".setData('residentVisualProfile', body.getData('villageWorkerVisualProfile'))");
        expect(world).toContain(".setData('routeType', routine.route)");
        expect(world).toContain(".setData('routeDirection', 'to_commons')");
        expect(world).toContain(".setData('villagePresenceModel', 'single_world_location_v1')");
        expect(world).toContain(".setData('greeting', routine.greeting)");
        expect(world).toContain('playVillageResidentGreeting(landmark, journey)');
        expect(world).toContain('clearVillageResidentGreeting(landmark)');
        expect(world).toContain(".setData('presentation', 'resident_attached_current_ribbon_v2')");
        expect(world).toContain(".setData('independentWorldLayer', true)");
        expect(world).toContain(".setData('contrastProfile', 'high_contrast_current_v2')");
        expect(world).toContain(".setData('backdropOpacity', 0.97)");
        expect(world).toContain("const bodyFontSize = compact ? 16 : 15;");
        expect(world).toContain("kind === 'resident_greeting'");
        expect(world).toContain('`${residentName.toUpperCase()} · AT HEART`');
        expect(world).toContain("this.scene.events.on('postupdate', syncGreeting)");
        expect(world).toContain("this.scene.events.off('postupdate', landmark.residentGreetingSync)");
        expect(world).toContain('const screenSpaceScale = 1 / zoom;');
        expect(world).toContain(".setData('effectiveScreenWidth', width)");
