    ...
    app.innerHTML = `
        <main class="legal-page">
            ...
            <article>
                ...
                <p>The public website may use Google Analytics to count visits, the general route people arrived from—including YouTube, LinkedIn, search or a direct link—whether website buttons lead to the game or sharing, and how much of the website film is watched in broad progress bands. It is off by default: Google is not loaded before permission. If you choose “Allow analytics”, Google receives the public page category, that broad arrival group, the general button area, approved campaign labels and the normal connection and device information used by web analytics. Google may also create basic visit and session events after permission is given. Mythical Void does not send Google the full page you came from, a message recipient, contact detail, creature detail, game activity, or arbitrary information after a question mark in a web address. It is not used in the game, and advertising features are switched off. Choose “No thanks” instead, or use “Analytics choices” in the footer to withdraw permission. Withdrawal reloads this page to stop the Google tag.</p>
                    <h2>Playing now</h2>
            ...
            <section class="systems-section" id="how-it-works">
                <div class="section-inner">
                    ...
                    <div class="systems-grid">
                        ...
                        <article class="system-card"><span class="system-index">03</span><h3>Your creature, reimagined</h3><p>Experimental tools can turn fictional creature details into a private Living Portrait or short AI-made Creature Story Scene. The player’s name, age range, location, words, photograph and voice are not sent to the image or video model. The main adventure keeps working if the extra media is slow or unavailable.</p><a href="/parents/">Read the family notes →</a></article>
