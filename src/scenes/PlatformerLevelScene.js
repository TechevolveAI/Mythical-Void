...
class PlatformerLevelScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Native onboarding fallbacks live outside Phaser's display list. A
        // forced scene recovery can bypass their original owner's shutdown,
        // so every expedition enforces the same boundary as the Sanctuary.
