const PERSONALITY_DIALOGUE = Object.freeze({
    curious: Object.freeze({
        greetings: Object.freeze({
            happy: Object.freeze(['{name} traces a new pattern in the air. "I found a signal our map does not explain."']),
            neutral: Object.freeze(['{name} studies the edge of the clearing. "Something changed while we were gone."']),
            sad: Object.freeze(['{name} stays near the ship. "My signal is low, but I am still listening."']),
        ...
        responses: Object.freeze({
            ...
            feelings: '"Alert. Not afraid. The Current is carrying a signal I have not heard before."',
            ...
            story: '"The oldest signal begins under the Sanctuary. I have only found its first turn."'
        })
    }),
    playful: Object.freeze({
        greetings: Object.freeze({
            ...
            neutral: Object.freeze(['{name} waits beside three rearranged signal stones. "One of these is a trap. Probably."']),
            sad: Object.freeze(['{name} nudges a signal stone without following it. "I could use a better game than waiting."']),
    ...
    gentle: Object.freeze({
        greetings: Object.freeze({
            happy: Object.freeze(['{name} waits beside new growth near the garden. "The smallest signals stayed. Come and see."']),
        ...
        responses: Object.freeze({
            general: '"The clearing held together. I kept the smaller signals away from the cold edge."',
            ...
            affection: '"Your signal is familiar now. Familiar is not the same as owned."',
    ...
    wise: Object.freeze({
        greetings: Object.freeze({
            ...
            upset: Object.freeze(['{name} faces the relay. "A false signal is using a familiar rhythm."'])
        }),
        responses: Object.freeze({
    ...
    energetic: Object.freeze({
        greetings: Object.freeze({
            happy: Object.freeze(['{name} returns from the Sanctuary boundary. "Clear route. Strong signal. We can move now."']),
            neutral: Object.freeze(['{name} paces a measured line beside the ramp. "I checked the perimeter twice. The third pass is yours."']),
            sad: Object.freeze(['{name} stays near the warm hull. "My signal is slower today. I can still choose the route."']),
        ...
        responses: Object.freeze({
            ...
            feelings: '"Ready to move. Staying still is making the signal harder to read."',
            adventure: '"The longest route reaches two signals. We take that one."',
