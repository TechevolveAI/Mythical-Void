...
async function playApproach(page,context,output,name) {
    ...
    return {arrival,first,resumed,caught,rejoined,second,arenaEntry:progress,jumpEvidence,realInput:true,debugTeleport:false};
}
