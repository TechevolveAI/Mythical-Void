...
requireValue(playable.indexOf('/returning-player.js?v=20260826-return-doorway') < playable.indexOf('/discovery.js?v=20260826-intent-sharing'), 'return helper must load before the game-finder script');
