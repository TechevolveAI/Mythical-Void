...
requireValue(playable.indexOf('/returning-player.js?v=20260827-direct-play') < playable.indexOf('/discovery.js?v=20260827-dedicated-hatch'), 'return helper must load before the game-finder script');
