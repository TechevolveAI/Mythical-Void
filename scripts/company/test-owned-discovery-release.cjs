...
try {
    ...
    assert.strictEqual(output.sitemapUrlCount, 17);
...
invalid('README.md', source => source.replace('[Play Mythical Void](https://mythicalvoid.com/play/)', 'Play sometime'), 'public GitHub doorway is missing');
