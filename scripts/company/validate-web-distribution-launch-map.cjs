...
for (const phrase of ['What the Poki check found', '3.77 MB compressed', '28.4 MiB compressed', 'not ready to submit, preserve the option', 'The important choice we nearly missed', 'For maximum upside', '0 of 4 approved moments', 'YouTube Playables', 'Why itch.io is still first if speed wins']) {
