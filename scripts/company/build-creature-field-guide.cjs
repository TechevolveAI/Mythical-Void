    ...
    <section class="field-realm" id="${escapeHtml(realm.id)}" data-field-realm>
        <div class="section-inner">
            ...
            <div class="field-realm-context">
                <div class="field-realm-signal" aria-label="Project Beacon record for ${escapeHtml(realm.label)}"><span>REALM ${escapeHtml(realm.number)}</span><strong>${escapeHtml(realm.label)}</strong><small>REALM PARTLY HEALED</small></div>
