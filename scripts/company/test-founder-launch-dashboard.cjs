...
function run(name, changes = {}) {
    ...
    const paths = ['evidence', 'outreach', 'activation', 'itch', 'launch'].map(key => {
...
try {
    ...
    console.log('Founder launch dashboard tests passed: valid snapshot plus 5 drift and authority mutations checked.');
} finally {
