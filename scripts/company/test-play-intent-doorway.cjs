...
invalid('docs/company/growth/PLAY_INTENT_DOORWAY.json', source => source.replace('"productionDeployId": "6a8fac1d80c28500086236a1"', '"productionDeployId": "unverified"'), 'production verification is missing or drifted');
