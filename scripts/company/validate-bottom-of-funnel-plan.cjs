...
for (const phrase of ['LOOKING FOR A NEW GAME? PLAY THIS ONE', 'Hatch a strange alien creature. Save six living realms.', 'Free · No download · No account · No payment details · Early access', 'Hatch a creature shaped by genetics']) {
