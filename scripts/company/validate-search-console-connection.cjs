...
requireValue(connection.sitemap?.url === 'https://mythicalvoid.com/sitemap.xml' && connection.sitemap?.publicStatusObserved === 200 && connection.sitemap?.publicRouteCountObserved === 10, 'Live sitemap foundation must remain recorded accurately.');
