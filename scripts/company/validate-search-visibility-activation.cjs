...
const previousChangedPageIndexNow = JSON.parse(read('docs/company/search/indexnow-submission-2026-08-27-02.json'));
const changedPageIndexNow = JSON.parse(read('docs/company/search/indexnow-submission-2026-08-27-03.json'));
...
requireValue(audit.indexNow?.previousMeaningfulChange?.record === 'docs/company/search/indexnow-submission-2026-08-27-02.json', 'previous changed-page notification evidence link is missing');
...
requireValue(previousChangedPageIndexNow.id === 'INDEXNOW-2026-08-27-02' && previousChangedPageIndexNow.accepted === true && previousChangedPageIndexNow.urlCount === 2, 'previous changed-page IndexNow evidence is invalid');
requireValue(audit.indexNow?.latestMeaningfulChange?.record === 'docs/company/search/indexnow-submission-2026-08-27-03.json', 'latest changed-page notification evidence link is missing');
...
requireValue(changedPageIndexNow.id === 'INDEXNOW-2026-08-27-03' && changedPageIndexNow.host === 'mythicalvoid.com', 'changed-page IndexNow evidence identity is invalid');
