...
requireValue(page.includes('/discovery.css?v=20260827-dedicated-hatch') && page.includes('/discovery.js?v=20260827-dedicated-hatch'), 'game-finder assets need a matching fresh cache version');
